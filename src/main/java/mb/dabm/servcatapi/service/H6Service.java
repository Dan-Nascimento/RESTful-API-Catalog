...
public class H6Service {
    ...
    public Page<H6> findByAll(int page, int size) { return repository.getByAll(PageRequest.of(page, size));}


    public H6 findByIncId(String inc) {return repository.getByIncId(inc);}
    ...
    public List<H6> findByIncTabelas(String inc) { return repository.getByIncTabelas(inc);}
